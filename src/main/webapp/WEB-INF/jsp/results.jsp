...
<body>
	...
	<header>
		<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
			<div class="container-fluid">
				<a class="navbar-brand" href="/">Millertime Dealership Inventory</a>
				...
				<div class="collapse navbar-collapse" id="navbarCollapse">
					<ul class="navbar-nav me-auto mb-2 mb-md-0">
						<li class="nav-item"><a class="nav-link" href="getAll">View Inventory</a></li>
	...
	<main role="main" class="inner cover">
		...
		<table class="table table-dark table-hover">
			...
			<c:forEach items="${resultOfVehicles}" var="vehicle">
				...
				<tbody>
					<tr>
						...
						<td>${vehicle.model}</td>
						<td>${vehicle.price}</td>
						<td><a class="btn btn-light" href="/details?vinNumber=${vehicle.vinNumber}" >More Info</a></td>
					</tr>
				</tbody>
			</c:forEach>
