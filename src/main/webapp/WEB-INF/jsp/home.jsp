...
<head>
<meta charset="utf-8">
<title>Dealership Account</title>
...
<link href="assets/css/style.css" rel="stylesheet">
	...
	<header>
		...
		<main role="main" class="inner cover">
			...
			<p class="lead">Welcome Back ${loggedInCustomer.firstName}
				${loggedInCustomer.lastName}. Click below to find all of your transactions with Millertime Dealership.</p>
			<p class="btn-center">
				<a href="/customer-transactions?customerId=${loggedInCustomer.customerId}" class="btn btn-lg btn-secondary">View Transactions</a>
			</p>
		</main>
		</div>
